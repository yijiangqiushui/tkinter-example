...
def buju(root):
    ...
    buttonMC=tkinter.Button(root,text='MC',width=3)
    buttonMR=tkinter.Button(root,text='MR',width=3)
    buttonMS=tkinter.Button(root,text='MS',width=3)
    buttonM1=tkinter.Button(root,text='M+',width=3)
    buttonM2=tkinter.Button(root,text='M-',width=3)
    ...
    buttonJ=tkinter.Button(root,text='←',width=3,command=anjianzhi('c').tui)
    buttonCE=tkinter.Button(root,text='CE',width=3)
    buttonC=tkinter.Button(root,text=' C ',width=3,command=anjianzhi('c').clear)
    button12=tkinter.Button(root,text='±',width=3,command=anjianzhi('c').zhengfu)
    buttonD=tkinter.Button(root,text='√',width=3,command=anjianzhi('sqrt').yunshuan)
    ...
    button7=tkinter.Button(root,text=' 7 ',width=3,command=anjianzhi('7').jia)
    button8=tkinter.Button(root,text=' 8 ',width=3,command=anjianzhi('8').jia)
    button9=tkinter.Button(root,text=' 9 ',width=3,command=anjianzhi('9').jia)
    buttonc=tkinter.Button(root, text=' / ',width=3,command=anjianzhi('/').yunshuan)
    buttonf= tkinter.Button(root, text=' % ',width=3)
    ...
    button4=tkinter.Button(root,text=' 4 ',width=3,command=anjianzhi('4').jia)
    button5=tkinter.Button(root,text=' 5 ',width=3,command=anjianzhi('5').jia)
    button6=tkinter.Button(root,text=' 6 ',width=3,command=anjianzhi('6').jia)
    buttonx=tkinter.Button(root,text=' * ',width=3,command=anjianzhi('*').yunshuan)
    buttonfs=tkinter.Button(root,text='1/x',width=3,command=anjianzhi('1/x').yunshuan)
    ...
    button1 = tkinter.Button(root, text=' 1 ',width=3, command=anjianzhi('1').jia)
    button2 = tkinter.Button(root, text=' 2 ',width=3, command=anjianzhi('2').jia)
    button3 = tkinter.Button(root, text=' 3 ',width=3, command=anjianzhi('3').jia)
    button_= tkinter.Button(root, text=' - ',width=3, command=anjianzhi('-').yunshuan)
    buttondy= tkinter.Button(root, text=' \n = \n ',width=3,command=anjianzhi('=').yunshuan)
